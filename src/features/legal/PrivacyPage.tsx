          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Ankòccitan s'engage à protéger votre vie privée. Cette politique
                de confidentialité explique comment nous collectons, utilisons
                et protégeons vos informations personnelles lorsque vous
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  ...
                  <li>
                    Pour fournir des services essentiels (hébergement, analyse)
                  </li>
                  <li>Pour respecter des obligations légales</li>
                  <li>Pour protéger nos droits et notre sécurité</li>
                </ul>
                <p className="text-gray-700">
                  <strong>Note :</strong> Le contenu que vous partagez
                  publiquement (decks, cartes) peut être visible par d'autres
                  utilisateurs.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                obligations légales. Les données peuvent être supprimées à votre
                demande ou après une période d'inactivité prolongée.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                par e-mail ou via notre site web. Votre utilisation continue du
                service après les modifications constitue votre acceptation de
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  <strong>Email :</strong>
                  <a
                    href="mailto:privacy@ankoccitan.com"
                ...
                <p className="text-gray-700 mt-2">
                  ...
                  <a
                    href="mailto:dpo@ankoccitan.com"
                    className="text-occitan-red hover:text-occitan-orange transition-colors duration-200 ml-1"
                  >
                    dpo@ankoccitan.com
                  </a>

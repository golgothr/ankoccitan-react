          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                En utilisant Ankòccitan, vous acceptez d'être lié par ces conditions d'utilisation. 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Ankòccitan est une plateforme d'apprentissage de l'occitan utilisant la méthode des cartes mémoire (spaced repetition). 
                Notre service permet de créer, partager et étudier des decks de cartes pour l'apprentissage de la langue occitane.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <p className="text-gray-700">
                  Pour utiliser certaines fonctionnalités d'Ankòccitan, vous devez créer un compte. 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Contenu utilisateur</h2>
              <div className="space-y-4">
                <p className="text-gray-700">
                  Vous conservez la propriété du contenu que vous créez sur Ankòccitan. 
                  En partageant du contenu, vous accordez à Ankòccitan une licence non exclusive 
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  ...
                  <li>Contenant des informations personnelles d'autrui sans consentement</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Vous vous engagez à utiliser Ankòccitan uniquement à des fins légales et éducatives. 
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>Utiliser des bots ou scripts automatisés sans permission</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Ankòccitan et son contenu original sont protégés par les droits d'auteur et autres lois 
                de propriété intellectuelle. Vous ne pouvez pas copier, modifier ou distribuer 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Ankòccitan est fourni "tel quel" sans garanties. Nous ne sommes pas responsables 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                <a href="mailto:contact@ankoccitan.com" className="text-occitan-red hover:text-occitan-orange transition-colors duration-200 ml-1">

      ...
      <div className="py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Voici un aperçu de votre activité et de vos progrès dans
            l'apprentissage de l'occitan.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/30">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-sm text-occitan-red hover:text-occitan-orange transition-colors duration-200">
                  Voir tout
                </button>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/30">
              ...
              <div className="space-y-4">
                <button className="flex items-center p-4 bg-gradient-to-r from-occitan-red to-occitan-orange rounded-lg text-white hover:from-occitan-orange hover:to-occitan-red transition-all duration-300 transform hover:scale-105 shadow-lg">
                  <svg
                ...
                <button className="flex items-center p-4 bg-white border-2 border-occitan-orange rounded-lg text-occitan-orange hover:bg-occitan-orange hover:text-white transition-all duration-300 transform hover:scale-105">
                  <svg
                    className="h-6 w-6 mr-3"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <button className="flex items-center p-4 bg-white border-2 border-occitan-red rounded-lg text-occitan-red hover:bg-occitan-red hover:text-white transition-all duration-300 transform hover:scale-105">
                  <svg
                    className="h-6 w-6 mr-3"
                    fill="none"
                    viewBox="0 0 24 24"

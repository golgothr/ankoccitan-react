-- =====================================================
-- CORRECTIONS DE PERFORMANCE RLS
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_user_profile_extended_is_public ON public.user_profile_extended(is_public);
...
CREATE INDEX IF NOT EXISTS idx_deck_shares_user_id ON public.deck_shares(user_id);
